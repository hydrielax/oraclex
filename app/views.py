...
from app.forms import RequeteForm, AjoutForm, RecapFichier
from app.models import Jugement, Juridiction, MotCle, Responsable, TypeJuridiction, GroupeMotCle
from app.scripts.recherche import *
...
def resultat(request):
    ...
    return render(request, 'recherche/resultat.html', {
...
def ajouts(request):
    if request.method == 'POST':
        ...
        ajout = AjoutForm()
        context = {'ajout': ajout}
    return render(request, 'ajouts/index.html', context)


#@login_required
#def ajouts_validation(request):
